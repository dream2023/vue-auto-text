<template>
  <div id="app">
    <easy-github-pages
      :menus="menuList"
      author="zhangchaojie"
      githubUrl="https://github.com/dream2023/vue-auto-text"
      homepage="https://github.com/dream2023"
      title="vue-auto-text | 文字大小自适应组件"
    >
      <section id="intro">
        <h2>介绍</h2>
      ...
      <section id="install">
        <h2>安装</h2>
        <blockquote>npm install vue-auto-text --save</blockquote>
      </section>
      <section id="usage">
        <h2>使用</h2>
        <blockquote>
      ...
      <section id="template">
        <h2 class="template">示例</h2>
        <p style="color: red;margin-bottom: 10px;">你可以自己输入内容试试</p>
        <div>
          <p>1.文本获取(text属性传值和插槽)</p>
          <iframe
            allowfullscreen="allowfullscreen"
            frameborder="0"
            height="350"
            src="//jsrun.net/DRXKp/embedded/all/light/"
            width="100%"
          ></iframe>
        </div>
        <div>
          <p>2.文本超出宽度(ellipsis 超出省略、clip 超出截断、break 超出换行)</p>
          <iframe
            allowfullscreen="allowfullscreen"
            frameborder="0"
            height="480"
            src="//jsrun.net/rRXKp/embedded/all/light/"
            width="100%"
          ></iframe>
        </div>
      </section>
